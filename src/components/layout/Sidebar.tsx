  ...
  return (
    <aside
      className={cn(
        ...
        'border-r border-amber-500/15 bg-sidebar/95 shadow-[inset_-1px_0_0_oklch(0.88_0.06_82_/_8%)]',
        'backdrop-blur-xl supports-[backdrop-filter]:bg-sidebar/80',
      )}
    >
      <div className="border-b border-amber-500/10 px-5 py-6">
        <div className="flex items-center gap-3">
          <div className="flex size-10 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-400/25 to-amber-600/10 ring-1 ring-amber-400/25">
      ...
      <nav className="flex flex-col gap-1 p-3">
        <button
          type="button"
          onClick={() => onSelectView('clientes_potenciales')}
          className={cn(
        ...
        <button
          type="button"
          onClick={() => onSelectView('prospectos')}
          className={cn(
            'group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-sm font-medium transition-all',
        ...
        <button
          type="button"
          onClick={() => onSelectView('plan_interacciones')}
          className={cn(
            'group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-sm font-medium transition-all',
        ...
        <button
          type="button"
          onClick={() => onSelectView('analiticas')}
          className={cn(
            'group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-sm font-medium transition-all',
      ...
      <div className="mt-auto border-t border-amber-500/10 p-4">
        <p className="text-[11px] leading-snug text-stone-500">
          ...
          <span className="text-amber-200/70">Clientes</span> separan quién aún no ha aceptado y quién ya sí.
        </p>
      </div>
    </aside>
  )
